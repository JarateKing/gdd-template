...
You can create keyboard input visuals with \keys{\ctrl + \shift + p} or controller buttons like \img{latex/images/controller_y.png} \img{latex/images/controller_dpad_right.png}
