...
\renewcommand{\gddShowTodos}{True}
\renewcommand{\gddShowNotes}{True}
...
\subsection{Sequel Summary}

\gddRuleofthirds{
	\item \gddtodo{Old thing}
}
{
	\item \gddtodo{Better thing.}
}
{
	\item \gddtodo{New thing.}
}

\gddnote{This is based on Sid Meier's Rule of Thirds, in other words sequels being "a third the same, a third improved, and a third new." Feel free to omit this entire section if it doesn't apply.}
